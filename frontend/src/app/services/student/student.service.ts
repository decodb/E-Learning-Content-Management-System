...
import { UserReview } from '../../pages/dashboards/student/student-course/feedbacks/write-review/review.model';
...
export class StudentService {
  ...
  postReview(id: string, studentReview: UserReview): Observable<any> {
    return this.httpClient.post<any>(`http://localhost:3001/api/student/courses/${id}/write-review`, studentReview);
  }
}
